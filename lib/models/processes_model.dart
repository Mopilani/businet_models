...
import 'dms/subscriper_model.dart';
import 'patchs.dart';
...
class ProcessesModel {
  ...
  ProcessesModel(
    ...
    this.lastDialyId = 1,
    this.lastReceiptId = 1,
    this.lastSuspendedReceiptId = 1,
    this.lastSKUId = 0,
  ...
  Future<int> requestSuspendedReceiptId() async {
    lastSuspendedReceiptId++;
    // await edit();
    return lastSuspendedReceiptId;
  }
  ...
  Map<String, dynamic> toMap() => {
        ...
        'lastSuspendedReceiptId': lastSuspendedReceiptId,
...
String timeToString(DateTime datetime, [String sparator = ':']) {
  return '${datetime.hour}$sparator${datetime.minute}';
}
