...
class ActionDataModel {
  ...
  static const Map<String, dynamic> registeredActions = {
    ...
    'ucrncy': 'تحديث عملة',
    'dcrncy': 'حذف عملة',
    'ctrmnac': 'انشاء حساب رئيسي',
    'utrmnac': 'تحديث حساب رئيسي',
    'dtrmnac': 'حذف حساب رئيسي',
    'ctrsbac': 'انشاء حساب فرعي',
    'utrsbac': 'تحديث حساب فرعي',
    'dtrsbac': 'حذف حساب فرعي',
  };
  ...
  static const String createdCurrency = 'ccrncy';
  static const String updatedCurrency = 'ucrncy';
  static const String deletedCurrency = 'dcrncy';

  static const String createdTreeMainAccount = 'ctrmnac';
  static const String updatedTreeMainAccount = 'utrmnac';
  static const String deletedTreeMainAccount = 'dtrmnac';

  static const String createdTreeSubAccount = 'ctrsbac';
  static const String updatedTreeSubAccount = 'utrsbac';
  static const String deletedTreeSubAccount = 'dtrsbac';
