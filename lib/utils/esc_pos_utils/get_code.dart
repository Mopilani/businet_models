...
Future<List<int>> sendDesign(String path, rootBundle) async {
  final profile = await CapabilityProfile.load(rootBundle);
...
Future<List<int>> sendPath(String path, rootBundle) async {
  final profile = await CapabilityProfile.load(rootBundle);
  final generator = Generator(PaperSize.mm80, profile);
  List<int> bytes = [];
...
Future<List<int>> getInitCode(rootBundle) async {
  final profile = await CapabilityProfile.load(rootBundle);
  final generator = Generator(PaperSize.mm80, profile);
  List<int> bytes = [];
...
Future<List<int>> getEndCode(rootBundle) async {
  final profile = await CapabilityProfile.load(rootBundle);
  final generator = Generator(PaperSize.mm80, profile);
  List<int> bytes = [];
...
Future<List<int>> getCode(rootBundle) async {
  final profile = await CapabilityProfile.load(rootBundle);
  final generator = Generator(PaperSize.mm80, profile);
  List<int> bytes = [];
