...
const Map<int, dynamic> _arabicSubstitionA = <int, dynamic>{
  ...
  0x0621: <int>[1569], // ء
  0x0622: <int>[1570, 0xFE82], // آ ﺂ
  0x0623: <int>[1571, 0xFE84], // أ ﺄ
  0x0624: <int>[1572, 0xFE86], // ؤ ﺆ
  0x0625: <int>[1573, 0xFE88], // إ ﺈ
  0x0626: <int>[1574, 0xFE8A, 0xFE8B, 0xFE8C], // ئ ﺊ ﺋ ﺌ
  0x0627: <int>[1575, 0xFE8E], // ا ﺎ
  0x0628: <int>[1576, 0xFE90, 0xFE91, 0xFE92], // ب ﺐ ﺑ ﺒ
  0x0629: <int>[1577, 0xFE94], // ة ﺔ
  0x062A: <int>[1578, 0xFE96, 0xFE97, 0xFE98], // ت ﺖ ﺗ ﺘ
  0x062B: <int>[1579, 0xFE9A, 0xFE9B, 0xFE9C], // ث ﺚ ﺛ ﺜ
  0x062C: <int>[1580, 0xFE9E, 0xFE9F, 0xFEA0], // ج ﺞ ﺟ ﺠ
  0x062D: <int>[1581, 0xFEA2, 0xFEA3, 0xFEA4], // ح ﺢ ﺣ ﺤ
  0x062E: <int>[1582, 0xFEA6, 0xFEA7, 0xFEA8], // خ ﺦ ﺧ ﺨ
  0x062F: <int>[1583, 0xFEAA], // د ﺪ
  0x0630: <int>[1584, 0xFEAC], // ذ ﺬ
  0x0631: <int>[1585, 0xFEAE], // ر ﺮ
  0x0632: <int>[1586, 0xFEB0], // ز ﺰ
  0x0633: <int>[1587, 0xFEB2, 0xFEB3, 0xFEB4], // س ﺲ ﺳ ﺴ
  0x0634: <int>[1588, 0xFEB6, 0xFEB7, 0xFEB8], // ش ﺶ ﺷ ﺸ
  0x0635: <int>[1589, 0xFEBA, 0xFEBB, 0xFEBC], // ص ﺺ ﺻ ﺼ
  0x0636: <int>[1590, 0xFEBE, 0xFEBF, 0xFEC0], // ض ﺾ ﺿ ﻀ
  0x0637: <int>[1591, 0xFEC2, 0xFEC3, 0xFEC4], // ط ﻂ ﻃ ﻄ
  0x0638: <int>[1592, 0xFEC6, 0xFEC7, 0xFEC8], // ظ ﻆ ﻇ ﻈ
  0x0639: <int>[1593, 0xFECA, 0xFECB, 0xFECC], // ع ﻊ ﻋ ﻌ
  0x063A: <int>[1594, 0xFECE, 0xFECF, 0xFED0], // غ ﻎ ﻏ ﻐ
  0x0641: <int>[1601, 0xFED2, 0xFED3, 0xFED4], // ف ﻒ ﻓ ﻔ
  0x0642: <int>[1602, 0xFED6, 0xFED7, 0xFED8], // ق ﻖ ﻗ ﻘ
  0x0643: <int>[1603, 0xFEDA, 0xFEDB, 0xFEDC], // ك ﻚ ﻛ ﻜ
  0x0644: <int>[1604, 0xFEDE, 0xFEDF, 0xFEE0], // ل ﻞ ﻟ ﻠ
  0x0645: <int>[1605, 0xFEE2, 0xFEE3, 0xFEE4], // م ﻢ ﻣ ﻤ
  0x0646: <int>[1606, 0xFEE6, 0xFEE7, 0xFEE8], // ن ﻦ ﻧ ﻨ
  0x0647: <int>[1607, 0xFEEA, 0xFEEB, 0xFEEC], // ه ﻪ ﻫ ﻬ
  0x0648: <int>[1608, 0xFEEE], // و ﻮ
  0x0649: <int>[1609, 0xFEF0, 64488, 64489], // ى ﻰ ﯨ ﯩ
  0x064A: <int>[1610, 0xFEF2, 0xFEF3, 0xFEF4], // ي ﻲ ﻳ ﻴ
  0x0671: <int>[0xFB50, 0xFB51], // ﭐ ﭑ
  0x0677: <int>[0xFBDD], // ﯝ
  0x0679: <int>[0xFB66, 0xFB67, 0xFB68, 0xFB69], // ﭦ ﭧ ﭨ ﭩ
  0x067A: <int>[0xFB5E, 0xFB5F, 0xFB60, 0xFB61], // ﭞ ﭟ ﭠ ﭡ
  0x067B: <int>[0xFB52, 0xFB53, 0xFB54, 0xFB55], // ﭒ ﭓ ﭔ ﭕ
  0x067E: <int>[0xFB56, 0xFB57, 0xFB58, 0xFB59], // ﭖ ﭗ ﭘ ﭙ
  0x067F: <int>[0xFB62, 0xFB63, 0xFB64, 0xFB65], // ﭢ ﭣ ﭤ ﭥ
  0x0680: <int>[0xFB5A, 0xFB5B, 0xFB5C, 0xFB5D], // ﭚ ﭛ ﭜ ﭝ
...
const Map<int, int> _arabicDiacritics = <int, int>{
  0x064B: 0x064B, // Fathatan الفتحتين
  0x064C: 0x064C, // Dammatan الضمتين
  0x064D: 0x064D, // Kasratan الكسرتين
  0x064E: 0x064E, // Fatha الفتحة
  0x064F: 0x064F, // Damma الضمة
  0x0650: 0x0650, // Kasra الكسرة
  0x0651: 0x0651, // Shadda الشدة
  0x0652: 0x0652, // Sukun السكون
...
Iterable<String> _parse(String text) sync* {
  // text = String.fromCharCodes(text.codeUnits.toList().reversed);
  ...
  for (final word in words) {
    ...
    for (var j = 0; j < word.length; j += 1) {
      ...
      if (_isArabicLetter(currentLetter)) {
        ...
        // print(position);
        // print(String.fromCharCode(_arabicSubstitionA[currentLetter][position]));
        prevLetter = currentLetter;
        // if (currentLetter == 0x0644) {
        //   print(
        //       'its Lam, SubSit Is: ${String.fromCharCode(_arabicSubstitionA[currentLetter][position])}');
        // }
        if (position != -1) {
          newWord.insert(0, _arabicSubstitionA[currentLetter][position]);
          // print(String.fromCharCodes(newWord.reversed));
        } else {
    ...
    if (isNewWordArabic) {
      ...
      newWord = newWord.reversed.toList();
